...
#include <stddef.h>
#include "can_interfaces/msg/detail/feedback__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  can_interfaces__msg__Feedback__init(message_memory);
}

void Feedback__rosidl_typesupport_introspection_c__Feedback_fini_function(void * message_memory)
{
  can_interfaces__msg__Feedback__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Feedback__rosidl_typesupport_introspection_c__Feedback_message_member_array[7] = {
  {
    "mst_id",  // name
    ...
    offsetof(can_interfaces__msg__Feedback, mst_id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_interfaces__msg__Feedback, id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_interfaces__msg__Feedback, pos),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_interfaces__msg__Feedback, vel),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_interfaces__msg__Feedback, tor),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_interfaces__msg__Feedback, t_mos),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(can_interfaces__msg__Feedback, t_rotor),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Feedback__rosidl_typesupport_introspection_c__Feedback_message_members = {
  ...
  7,  // number of fields
  sizeof(can_interfaces__msg__Feedback),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, can_interfaces, msg, Feedback)() {
