...
#include "test_omni_wheel_controller.hpp"
...
using omni_wheel_controller::CMD_MY_ITFS;
using omni_wheel_controller::control_mode_type;
using omni_wheel_controller::STATE_MY_ITFS;

class OmniWheelControllerTest : public OmniWheelControllerFixture<TestableOmniWheelController>
{
};

TEST_F(OmniWheelControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, update_success)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OmniWheelControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OmniWheelControllerTest, test_update_logic_chainable_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OmniWheelControllerTest, test_update_logic_chainable_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OmniWheelControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(OmniWheelControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
