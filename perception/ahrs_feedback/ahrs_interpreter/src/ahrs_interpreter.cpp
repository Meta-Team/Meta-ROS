...
#include "ahrs_interface/msg/angular_position.hpp"
...
public:
    AhrsInterpreter() : Node("ahrs_interpreter")
    {
        ...
        pub_ = this->create_publisher<ahrs_interface::msg::AngularPosition>("angular_position", 10);
    }

private:
    rclcpp::Subscription<geometry_msgs::msg::Vector3>::SharedPtr sub_;
    rclcpp::Publisher<ahrs_interface::msg::AngularPosition>::SharedPtr pub_;
