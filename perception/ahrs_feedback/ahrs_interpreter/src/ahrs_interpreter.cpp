...
#include "hardware_interface/msg/angular_position.hpp"
...
public:
    AhrsInterpreter() : Node("ahrs_interpreter")
    {
        ...
        pub_ = this->create_publisher<hardware_interface::msg::AngularPosition>("angular_position", 10);
    }

private:
    rclcpp::Subscription<geometry_msgs::msg::Vector3>::SharedPtr sub_;
    rclcpp::Publisher<hardware_interface::msg::AngularPosition>::SharedPtr pub_;

    void callback(const geometry_msgs::msg::Vector3::SharedPtr feedback_msg)
    {
        hardware_interface::msg::AngularPosition pub_msg;
