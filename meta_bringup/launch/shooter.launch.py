...
def generate_launch_description():
    ...
    robot_description_content = Command([
            ...
            ' ',
            PathJoinSubstitution([FindPackageShare('metav_description'), 'urdf', 'playground', 'shooter.xacro']),
            ' ',
    ...
    robot_controller_config = PathJoinSubstitution([FindPackageShare('meta_bringup'), 'config', 'shooter.yaml'])
