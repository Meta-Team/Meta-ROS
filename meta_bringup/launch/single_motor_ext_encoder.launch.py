...
def generate_launch_description():
    ...
    robot_description_content = Command([
            ...
            ' ',
            PathJoinSubstitution([FindPackageShare('metav_description'), 'urdf', 'playground', 'single_motor_ext_encoder.xacro']),
            ' ',
    ...
    gazebo_launch = IncludeLaunchDescription(
        ...
        launch_arguments=[
            ('world_sdf', world_sdf),
            ('robot_name', 'single_motor_ext_encoder'),
    ...
    robot_controller_config = PathJoinSubstitution([FindPackageShare('meta_bringup'), 'config', 'single_motor_ext_encoder.yaml'])
