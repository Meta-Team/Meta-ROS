...
def generate_launch_description():
    ...
    robot_description_content = Command([
            ...
            ' ',
            PathJoinSubstitution([FindPackageShare('metav_description'), 'urdf', 'hero', 'hero.xacro']),
            ' ',
    ...
    robot_config = PathJoinSubstitution([FindPackageShare('meta_bringup'), 'config', 'hero.yaml'])
