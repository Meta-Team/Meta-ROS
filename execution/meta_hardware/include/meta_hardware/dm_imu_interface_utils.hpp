#ifndef META_HARDWARE__DM_IMU_INTERFACE_UTILS__
#define META_HARDWARE__DM_IMU_INTERFACE_UTILS__
namespace meta_hardware
{
    // from https://gitee.com/kit-miao/dm-imu/blob/master
...
#endif // META_HARDWARE__DM_IMU_INTERFACE_UTILS__