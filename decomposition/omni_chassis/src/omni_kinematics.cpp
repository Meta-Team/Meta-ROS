...
void OmniKinematics::set_goal(motor_interface::msg::DjiGoal &motor_goals, const WheelId id, const float goal_vel, const float goal_pos, int order)
{
    motor_goals.motor_id[order] = id;
    motor_goals.goal_vel[order] = goal_vel;
    motor_goals.goal_pos[order] = goal_pos;
}